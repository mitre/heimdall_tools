...
module HeimdallTools
  class JfrogXrayMapper
    ...
    def to_hdf
      ...
      @project['data'].each do | vulnerability |
        ...
        item['id']                 = vulnerability_count.to_s
      ...
      results = HeimdallDataFormat.new(profile_name: "test", #scaninfo['policy'],
                                       version: "test", #scaninfo['version'],
                                       title: "test", #"Nikto Target: #{scaninfo['projectName']}",
                                       summary: "test", #"Banner: #{scaninfo['summary']}",
                                       controls: controls,
                                       target_id: "test")#scaninfo['projectName'])
      results.to_hdf
    end
